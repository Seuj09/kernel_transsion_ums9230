...
static void btf_float_show(const struct btf *btf, const struct btf_type *t,
			   u32 type_id, void *data, u8 bits_offset,
			   struct btf_show *show)
{
	btf_show_start_type(show, t, type_id, data);
	btf_show_type_value(show, "<float sz%u>", t->size);
	btf_show_end_type(show);
}
...
static void btf_decl_tag_show(const struct btf *btf, const struct btf_type *t,
			      u32 type_id, void *data, u8 bits_offset,
			      struct btf_show *show)
{
	btf_show_start_type(show, t, type_id, data);
			    ...
			    struct btf_show *show)
{
	...
	v = t->size == 8 ? *(u64 *)safe_data : *(u32 *)safe_data;
